...
var generateAd = function (numAvatar) {
    ...
    return {
        ...
        offer: {
            ...
            features: features,
            description: 'В квартире есть всё необходимое для комфортного отдыха и проживания: постельное бельё, полотенца, удобные ортопедические матрасы, бытовая техника, посуда, wi-fi, кабельное телевидение. 7 спальных мест(2+1+1+1+1). Сдаётся туристам, командированным, студентам-заочникам на период сессии, на часы, сутки.',
            photos: photos
        },
        location: {
